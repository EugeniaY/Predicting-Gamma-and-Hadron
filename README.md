# Predicting-Gamma-and-Hadron
Using Machine Learning to Predict Gamma and Hadron

<h2>Creating ML Environment using Conda</h2>
<ul>
...
<ul>
  <li>Make sure change to ml_project(Python 3.11.14)</li>
  <li>conda activate ml_project</li>
</ul>
